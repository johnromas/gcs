class ClaimsController < ApplicationController
  ...
  private
    ...
    def claim_params
      params.require(:claim).permit(:number, :claimant_id, :insurance_company_id, :adjustor_id, :doctor_id, :attorney_id, :litigated, :legal_notes, :service, :insured, :case, :date_of_injury, :notes, appointment_attributes: [:id, :date, :time, :doctor_id], claimant_attributes: [:id, :first_name, :last_name, :address, :city, :state_id, :zip, :phone, :mobile, :email, :ssn, :dob, :gender, :notes])
    end
